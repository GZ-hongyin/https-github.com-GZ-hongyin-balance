...
def main(data_type='cifar10',loss_type='LDAM',train_rule ='None',resultFolder = 'Results/tmp'):
    ...
    if data_type == 'cifar10':
        train_dataset = IMBALANCECIFAR10(root='F:\代码\ljh\data', imb_type='exp', imb_factor=imb_ratio,
                                         rand_number=0, train=True, download=True,
                                         transform=transform_train)
        val_dataset = datasets.CIFAR10(root='F:\代码\ljh\data', train=False, download=True, transform=transform_val)

    elif data_type == 'cifar100':
        train_dataset = IMBALANCECIFAR100(root='./data', imb_type='exp', imb_factor=0.01,
                                          rand_number=0, train=True, download=True,
                                          transform=transform_train)
...
def validate(val_loader, model, criterion, epoch,log=None, tf_writer=None, flag='val'):
    batch_time = AverageMeter('Time', ':6.3f')
    losses = AverageMeter('Loss', ':.4e')
    top1 = AverageMeter('Acc@1', ':6.2f')
    top5 = AverageMeter('Acc@5', ':6.2f')
...
if __name__ == '__main__':
    main(data_type='cifar10',loss_type='CE',train_rule ='None')
