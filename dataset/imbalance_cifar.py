...
class IMBALANCECIFAR10(torchvision.datasets.CIFAR10):
    ...
    def __init__(self, root='./datasets/imbalance_cifar10', imb_type='exp', imb_factor=0.01, rand_number=0, train=True,
...
if __name__ == '__main__':
    ...
    trainset = IMBALANCECIFAR10(root='/home/cvk4_n1/douli/ljh/data', train=True,
