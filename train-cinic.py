...
from utils import saliencymix,remix,cutmix,mix,IMBALANCECINIC10




def main(data_type='cinic10', loss_type='LDAM', train_rule='none', resultFolder='Results/remix',imb_ratio = 0.01,imb_type= 'exp',
         mix_rule = 'none'):
    ...
    transform_train = transforms.Compose([
        ...
        transforms.ToTensor(),
        transforms.Normalize((0.47889522, 0.47227842, 0.43047404), (0.24205776, 0.23828046, 0.25874835)),  # 三个通道
    ])
    ...
    if data_type == 'cinic10':
        train_dataset =  IMBALANCECINIC10(root='/home/cvk4_n1/douli/cinic-10/train',transform=transform_train,imb_type=imb_type, imb_factor=imb_ratio)
        #train_dataset = torchvision.datasets.ImageFolder(root='/home/cvk4_n1/douli/cinic-10/train',transform=transform_train)
        val_dataset = torchvision.datasets.ImageFolder(root='/home/cvk4_n1/douli/cinic-10/valid', transform=transform_val)
...
if __name__ == '__main__':
    #main(data_type='cinic10', loss_type='CE', train_rule='none',resultFolder='Results/CINIC/ERM',imb_ratio = 0.01)
    Fire(main)
