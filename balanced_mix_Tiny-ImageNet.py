...
from utils import mix,saliencymix,remix,cutmix,CRMix,split_train_valid,get_combo_loader


def main(data_type='Tiny-ImageNet', loss_type='CE', train_rule='none', resultFolder='Results',
...
#    os.environ["CUDA_VISIBLE_DEVICES"] = '0'
    ...
    data_dir = '/home/omnisky/HDisk5/dataset/tiny-imagenet-200'
    ...
    num_classes = 100 if data_type == 'cifar100' else 200
