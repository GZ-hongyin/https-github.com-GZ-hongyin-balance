...
from utils import remix,saliencymix,cutmix,mix


def main(data_type='cifar10', loss_type='CE', train_rule='none', resultFolder='Results',imb_ratio = 0.01,imb_type='step',mix_rule='none'):
...
if __name__ == '__main__':
    #main(data_type='cifar10', loss_type='CE', train_rule='none',resultFolder='Results/Saliency')
    Fire(main)
