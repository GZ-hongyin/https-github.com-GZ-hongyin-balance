...
from utils import mix, saliencymix, remix, cutmix, CRMix,IMBALANCECINIC10
import matplotlib.pyplot as plt
from utils import get_combo_loader


def main(data_type='cinic10', loss_type='CE', train_rule='none', resultFolder='Results',
...
#    os.environ["CUDA_VISIBLE_DEVICES"] = '0'
    ...
    if data_type == 'cifar10':
        ...
        train_dataset =  IMBALANCECINIC10(root='/home/omnisky/HDisk4/data/cinic/train',transform=transform_train,imb_type=imb_type, imb_factor=imb_ratio)
        #train_dataset = torchvision.datasets.ImageFolder(root='/home/cvk4_n1/douli/cinic-10/train',transform=transform_train)
        val_dataset = torchvision.datasets.ImageFolder(root='/home/omnisky/HDisk4/data/cinic/valid', transform=transform_val)
